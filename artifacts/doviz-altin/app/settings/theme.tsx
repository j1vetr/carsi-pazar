  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 32, paddingBottom: bottomPadding }}>
        <View style={{ width: 88, height: 88, borderRadius: 24, backgroundColor: "#EC48991A", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
          <Icon name="flame-outline" size={42} color="#EC4899" />
        </View>
        ...
        <Text style={{ fontSize: 14, fontFamily: "Inter_500Medium", color: colors.mutedForeground, textAlign: "center", marginTop: 10, lineHeight: 20 }}>
          Açık, koyu, OLED siyah ve altın varyantı seçenekleri ile uygulamanın görünümünü kişiselleştir. Yakında!
        </Text>
