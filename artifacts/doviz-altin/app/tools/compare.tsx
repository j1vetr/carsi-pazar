  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 32, paddingBottom: bottomPadding }}>
        <View style={{ width: 88, height: 88, borderRadius: 24, backgroundColor: "#06B6D41A", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
          <Icon name="swap-vertical" size={42} color="#06B6D4" />
        </View>
        ...
        <Text style={{ fontSize: 14, fontFamily: "Inter_500Medium", color: colors.mutedForeground, textAlign: "center", marginTop: 10, lineHeight: 20 }}>
          İki varlığı yan yana koy, performanslarını grafikle karşılaştır. Yakında!
        </Text>
